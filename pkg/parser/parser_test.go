	...
	}{
		{
			...
			expectedToolSet: &mcp.ToolSet{
				...
				Tools: []mcp.Tool{
					{
						Name:        "getPing",
						Description: "Note: The API key is supplied by the server, no need to provide it. Simple ping endpoint",
		...
		},
		{
			...
			expectedToolSet: &mcp.ToolSet{
				...
				Tools: []mcp.Tool{
					{
						Name:        "getHealth",
						Description: "Note: The API key is supplied by the server, no need to provide it. Simple health check",
						InputSchema: mcp.Schema{Type: "object", Properties: map[string]mcp.Schema{}, Required: []string{}},
					},
				},
				Operations: map[string]mcp.OperationDetail{
		...
		// --- Parameter/Schema Tests ---
		{
			...
			expectedToolSet: &mcp.ToolSet{
				...
				Tools: []mcp.Tool{
					{
						Name:        "testParams",
						Description: "Note: The API key is supplied by the server, no need to provide it. Test various params",
		...
		},
		{
			...
			expectedToolSet: &mcp.ToolSet{
				...
				Tools: []mcp.Tool{
					{
						Name:        "testV2Params",
						Description: "Note: The API key is supplied by the server, no need to provide it. Test V2 params and ref",
						InputSchema: mcp.Schema{
							Type: "object",
							Properties: map[string]mcp.Schema{
		...
		// --- Array Tests ---
		{
			...
			expectedToolSet: &mcp.ToolSet{
				...
				Tools: []mcp.Tool{
					{
						Name:        "processArrays",
						Description: "Note: The API key is supplied by the server, no need to provide it. Process arrays",
						InputSchema: mcp.Schema{
							Type: "object",
							Properties: map[string]mcp.Schema{
		...
		},
		{
			...
			expectedToolSet: &mcp.ToolSet{
				...
				Tools: []mcp.Tool{
					{
						Name:        "getArrays",
						Description: "Note: The API key is supplied by the server, no need to provide it. Get arrays",
						InputSchema: mcp.Schema{
							Type: "object",
							Properties: map[string]mcp.Schema{
								"string_array_query": {Type: "array", Items: &mcp.Schema{Type: "string"}},
		...
		},
		{
			...
			expectedToolSet: &mcp.ToolSet{
				...
				Tools: []mcp.Tool{
					{
						Name:        "uploadFile",
						Description: "Note: The API key is supplied by the server, no need to provide it. Upload file",
						InputSchema: mcp.Schema{
							Type: "object",
							Properties: map[string]mcp.Schema{
